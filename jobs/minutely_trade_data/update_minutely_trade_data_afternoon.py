...
# 早盘收盘
from jobs.minutely_trade_data.shared_config import AFTERNOON_MARKET_END_TIME
...
logger = get_logger('minutely_trade_data_etf_job_afternoon')
...
def run()->JobInfo:
    ...
    - JobInfo: 执行信息，用于邮件通知  
    '''
    job_name = 'update_minutely_trade_data_afternoon'
    ...
    # 条件满足，更新分钟交易数据
    while dt.datetime.now().time() < AFTERNOON_MARKET_END_TIME:
