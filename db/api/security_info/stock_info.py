...
def get_stock_info_by_code(code: str) -> pd.DataFrame:
    ...
    return _security_info_query.read_sql(q, (code, FALLBACK_STOCK_CODE))
...
def match_stock_info_by_name(name: str) -> pd.DataFrame:
    ...
    return _security_info_query.read_sql(q, (f'%{name}%', FALLBACK_STOCK_CODE))
...
def match_stock_info_by_exchange(exchange: str) -> pd.DataFrame:
    ...
    return _security_info_query.read_sql(q, (exchange, FALLBACK_STOCK_CODE))
